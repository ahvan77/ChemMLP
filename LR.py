...
class LinerR(QDialog):
    ...
    def  init_ui(self):   
       # self.setGeometry(100, 100, 50, 50)
        ...
        self.setWindowTitle('LR parameters')
        MyIcon(self)
    ...
    def run_svr(self):
        try:
                ...
                textfile.write('========================= '+ '\n')
                textfile.write('The Accuracy of  Linear Regression model is: ' + str(100-np.mean(APE)) + '\n')
                ...
                dialog.setWindowTitle('Linear Regression (LR) model Results')
                MyIcon(dialog)
                ...
                text_widget.setText(text_widget.text()+'The Accuracy of Linear Regression model is: ' + str(100-np.mean(APE)) + '\n')
           ...
           #     textfile = open(self.pixmappath +'LR_'+'Output.txt', 'w')
                df1[target+'_prediction']=Predictions1
                df1.to_csv(self.pixmappath +'LR_Output.csv', index=False, lineterminator='\n')
            #    textfile.close()    
