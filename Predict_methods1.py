...
from read_csv import AddRowWidget
#import descriptor
...
class MainWindow(QMainWindow):
   ...
   #     self.setStyleSheet("background-image: url(background.gif")
    ...
    def setupMenuBar(self):   
      ...
      #  Feature_action.triggered.connect(self.GUI_f)
        ...
        open_train1_action = QAction(QIcon(self.pixmappath0 + 'open_file1.jpg'), "T&rain", self)
        open_menu.addAction(open_train1_action)
        ...
        Train_add_action = QAction(QIcon(self.pixmappath0 + 'Manually.png'), "Add Data to Train data", self)
        Train_menu.addAction(Train_add_action)
        Train_add_action.triggered.connect(self.AddRow)
        
        p_action = QAction(QIcon(self.pixmappath0 + 'New.png'), "P&redict", self)
        ...
        f_action = QAction(QIcon(self.pixmappath0 + 'Features.png'), "F&eature", self)
   ...
   #     insert_menu.addAction(Feature_action)
        ...
        F_I_action = QAction(QIcon(self.pixmappath0 + 'Manually.png'), "I&nsert Manually", self)
